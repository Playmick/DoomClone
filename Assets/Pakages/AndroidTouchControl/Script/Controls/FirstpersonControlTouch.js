...
public var joyRotation = true; //Joy rotation control scheme
public var dragToLook = false; //Drag To Look control scheme
public var tiltRotation = false; //Tilt rotation control scheme
public var showControlOptions = false; //Control options
public var gameMode = true; //Control options
...
function OnGUI() {
    ...
    if(showControlOptions) {
        ...
        if(GUILayout.Button("Resume", GUILayout.Width(Screen.height/4), GUILayout.Height(Screen.height/10))){
        gameMode = true;
        ...
        fielwiev = GUILayout.HorizontalSlider(fielwiev, 10.0, 300.0); 
        GUILayout.EndVertical ();
        GUILayout.BeginHorizontal ("box");
        if(GUILayout.Button("Low Quality", GUILayout.Width(Screen.height/4), GUILayout.Height(Screen.height/10))){
        QualitySettings.currentLevel = QualityLevel.Fastest;
        }
        if(GUILayout.Button("Good Quality", GUILayout.Width(Screen.height/4), GUILayout.Height(Screen.height/10))){
...
function Update()
{
    Camera.main.farClipPlane = fielwiev;
